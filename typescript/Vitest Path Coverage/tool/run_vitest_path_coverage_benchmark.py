"""CLI entry point for Vitest Path Coverage benchmark."""
...
from _vitest_path_coverage_utils import (
    DEFAULT_REPO_URL,
    NotebookLogger,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Vitest Path Coverage validation benchmark.")
    ...
    printable = {
        ...
        if key not in {"coverage_summary_raw", "coverage_final_raw", "metrics_df", "report_markdown"}
    }
