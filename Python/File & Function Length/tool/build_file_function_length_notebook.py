"""Generate lizard_file_function_length_extraction.ipynb."""
...
cells = [
    md(
        ...
        "for File Length, Function Length, Cyclomatic Complexity (CCN), NLOC, Token Count, and Maximum Nesting Depth.\n\n"
        ...
        "**File Length is derived** by counting the total physical lines in each Python source file."
    ),
