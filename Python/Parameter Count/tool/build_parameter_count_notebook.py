"""Generate lizard_parameter_count_extraction.ipynb."""
...
cells = [
    md(
        "# Lizard Parameter Count — Raw Output Extraction (Python)\n\n"
        "This notebook analyzes **Python repositories** with **Lizard** and captures complete raw tool output "
