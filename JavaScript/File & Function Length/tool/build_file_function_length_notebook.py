"""Generate lizard_file_function_length_extraction.ipynb for JavaScript repositories."""
...
cells = [
    md(
        "# Lizard File & Function Length — Raw Output Extraction (JavaScript)\n\n"
        "This notebook analyzes **JavaScript repositories** with **Lizard** and captures complete raw tool output "
