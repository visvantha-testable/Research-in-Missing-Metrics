"""Generate lizard_parameter_count_extraction.ipynb for Java repositories."""
...
cells = [
    md(
        "# Lizard Parameter Count — Raw Output Extraction (Java)\n\n"
        "This notebook analyzes **Java repositories** with **Lizard** and captures complete raw tool output "
    ...
    md(
        ...
        "Run `lizard -l java --csv` and nesting analysis with `-ENS` (equivalent to `-E NS`).\n\n"
    ...
    md("## Section 8 — Parse Lizard Output\n\nGenerate per-method metrics with class and method names."),
    code(
