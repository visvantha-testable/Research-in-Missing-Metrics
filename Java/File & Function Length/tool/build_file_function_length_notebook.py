"""Generate lizard_file_function_length_extraction.ipynb for Java repositories."""
...
EXCLUDED_DIR_NAMES = {
    ".git", "target", "build", "bin", ".gradle", ".mvn", "generated-sources", "docs",
}
LIZARD_EXCLUDE_PATTERNS = [
    "*/.git/*", "*/target/*", "*/build/*", "*/bin/*", "*/.gradle/*",
...
cells = [
    md(
        "# Lizard File & Function Length — Raw Output Extraction (Java)\n\n"
        "This notebook analyzes **Java repositories** with **Lizard** and captures complete raw tool output "
        "for File Length, Function Length, Cyclomatic Complexity (CCN), NLOC, Token Count, Maximum Nesting Depth, "
