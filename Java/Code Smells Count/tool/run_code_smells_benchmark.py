"""Run PMD code smells benchmark pipeline."""
...
from run_code_smells_benchmark_impl import (
    DEFAULT_RULESETS,
...
BENCHMARK = METRIC_ROOT / "workspace" / "java_code_smells_benchmark"
...
if __name__ == "__main__":
    ...
    result = run_pipeline(BENCHMARK, OUTPUT, PMD_HOME, DEFAULT_RULESETS)
