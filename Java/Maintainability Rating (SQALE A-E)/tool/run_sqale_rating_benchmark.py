"""Run PMD maintainability rating benchmark pipeline."""
...
from run_sqale_rating_benchmark_impl import configure_java_runtime, download_pmd, run_pipeline

if __name__ == "__main__":
    configure_java_runtime(JDK_HOME)
    download_pmd(PMD_HOME, cache_dir=PROJECT_ROOT / "runtimes" / "cache")
    result = run_pipeline(BENCHMARK, OUTPUT, PMD_HOME, halstead_volume=5000.0)
