...
from _opentelemetry_utils import NotebookLogger, resolve_metric_root, run_pipeline  # noqa: E402
...
def main() -> int:
    ...
    try:
        result = run_pipeline(
            ...
            local_repo_path=str(metric_root / "workspace" / "csharp-testing-opentelemetry"),
